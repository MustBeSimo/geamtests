    ...
    >
      <div className="flex items-start gap-2">
        ...
        <div className="text-yellow-800 dark:text-yellow-200 text-sm">
          {compact ? (
            <p>
              <strong>Important:</strong> Mind Gleam offers self-help tools and
              educational content only. It is{' '}
              <strong>not a medical device</strong> and does not diagnose,
              treat, cure or prevent any disease or mental health condition.
            </p>
          ) : (
            <>
              <p className="font-semibold mb-2">Important Disclaimer</p>
              <p>
                Mind Gleam offers self-help tools and educational content only.
                It is <strong>not a medical device</strong> and does not
                diagnose, treat, cure or prevent any disease or mental health
                condition. If you feel unsafe or in crisis, call your local
