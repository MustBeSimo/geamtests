    ...
    if (avatarClasses) {
      switch (avatarId) {
        case 'gigi':
          return {
            gradient:
              'from-mindgleam-peach-200 via-mindgleam-peach-300 to-mindgleam-gold-200',
            hoverGradient:
              'from-mindgleam-peach-200/30 via-mindgleam-peach-300/30 to-mindgleam-gold-200/30',
          };
        case 'vee':
          return {
            gradient:
              'from-mindgleam-lavender-200 via-mindgleam-lavender-300 to-mindgleam-peach-200',
            hoverGradient:
              'from-mindgleam-lavender-200/30 via-mindgleam-lavender-300/30 to-mindgleam-peach-200/30',
          };
        case 'lumo':
          return {
            gradient:
              'from-mindgleam-mint-200 via-mindgleam-mint-300 to-mindgleam-lavender-200',
            hoverGradient:
              'from-mindgleam-mint-200/30 via-mindgleam-mint-300/30 to-mindgleam-lavender-200/30',
          };
        default:
          return {
