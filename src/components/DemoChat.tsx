...
const demoResponses = [
  {
    ...
    response:
      "Hello! I'm {name}, your AI mental wellness companion. I'm here to help you work through thoughts and feelings using evidence-based CBT techniques. What's on your mind today?",
  },
  {
    trigger: ['anxious', 'anxiety', 'worried', 'stress'],
    response:
      "I understand you're feeling anxious. That's a very common experience. Let's try a simple technique: Can you tell me what specific thoughts are making you feel this way? Sometimes just naming them helps reduce their power.",
  },
  {
    trigger: ['sad', 'depressed', 'down', 'low'],
    response:
      "I hear that you're feeling down. It takes courage to reach out. One thing that often helps is identifying what we call 'thought patterns.' What thoughts have been going through your mind lately?",
  },
  {
    trigger: ['angry', 'frustrated', 'mad', 'upset'],
    response:
      "Anger can be really intense. Let's work with it constructively. Can you describe the situation that triggered these feelings? Often there are underlying thoughts that fuel our anger.",
  },
  {
    trigger: ['help', 'support', 'need'],
    response:
      "I'm here to support you. CBT helps us understand the connection between our thoughts, feelings, and behaviors. What specific area would you like to focus on today - thoughts, emotions, or behaviors?",
  },
];

const defaultResponse =
  "Thank you for sharing that with me. In CBT principles, we explore how thoughts, feelings, and behaviors are connected. I'd love to help you explore this further. To continue our conversation and access personalized guidance, would you like to sign up for your 20 free messages?";

// Goal-specific sample conversations
const goalSamples = {
  sleep: {
    userMessage:
      "I can't sleep because I keep thinking about tomorrow's presentation. What if I mess up?",
    aiResponse:
      "I understand that worry about tomorrow is keeping you awake. Let's work with that 'what if' thought. You're catastrophizing - imagining the worst possible outcome. Instead, let's reframe: What if you do well? What if you're prepared? Even if there are small hiccups, would that truly be a disaster? Try this: Take 3 deep breaths and list 3 things you've done to prepare. Your mind needs facts, not fears, to rest peacefully.",
  },
  stress: {
    userMessage:
      "I'm so overwhelmed with work. I feel like I'm drowning and can't handle everything on my plate.",
    aiResponse:
      "That feeling of drowning is your mind's way of saying you're in overwhelm mode. Let's step back and challenge that 'I can't handle this' thought. You're dealing with a lot, but you're not actually drowning - you're here, you're talking about it, which shows you're coping. Let's break this down: What's one small task you could complete today? Sometimes our minds make mountains out of molehills. You've handled difficult situations before - what skills did you use then?",
  },
  confidence: {
    userMessage:
      "I want to apply for a promotion but I don't think I'm good enough. Everyone else seems more qualified.",
    aiResponse:
      "I hear that inner critic telling you 'you're not good enough.' This is a classic example of self-doubt and comparison thinking. Let's challenge this: What evidence do you have that you're not qualified? Are you comparing your behind-the-scenes to others' highlight reels? Think about it - your company wouldn't have the position available if they didn't think someone like you could do it. What are 3 specific achievements you're proud of? Let's reframe: Instead of 'I'm not good enough,' try 'I'm learning and growing, and I have valuable skills to offer.'",
  },
  anxiety: {
    userMessage:
      "I have a social event tonight and I'm already anxious about it. I keep imagining all the ways it could go wrong.",
    aiResponse:
      "Your mind is stuck in 'what if' mode - anticipating problems that haven't happened yet. This is anxiety's favorite trick. Let's reframe those anxious thoughts: Instead of 'What if I say something awkward?' try 'What if I have an interesting conversation?' Instead of 'What if no one likes me?' try 'What if I meet someone new?' Anxiety makes us fortune-tellers of doom, but you can choose to predict positive outcomes too. What's one thing you're actually looking forward to about tonight?",
  },
};
...
export default function DemoChat({
  ...
  const avatar =
    avatars[selectedAvatar as keyof typeof avatars] || avatars.gigi;
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              <div
                className={`w-12 h-12 rounded-full bg-gradient-to-br ${avatar.gradient} p-1`}
              >
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {sampleLoaded && messages.length > 0
                    ? `Sample Chat • ${3 - userMessageCount} messages remaining`
                    : 'Loading sample...'}
                </p>
              </div>
            </div>
            ...
            {sampleLoaded && messages.length > 0 && (
              <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                ...
                <p className="text-blue-600 dark:text-blue-400 text-xs">
                  This shows how {avatar.name} helps reframe anxious thoughts.
            ...
            {userMessageCount >= 3 ? (
              <div className="text-center space-y-4">
                <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-xl p-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                    Get 20 free messages with personalized guidance, mood
              ...
              <div>
                ...
                <div className="mt-2 text-xs text-gray-500 dark:text-gray-400 text-center">
                  Educational content only • Not medical advice • Ages 18+ •
