...
export const cbtPrompts: CBTPrompt[] = [
  {
    ...
    prompt:
      "Let's explore that thought together. What specific situation triggered this feeling? Describe what happened in just a few words.",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "I notice you might be imagining the worst-case scenario. Let's pause and examine this thought. What's the most realistic outcome here?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "It sounds like you're seeing this situation in black and white terms. What might be some middle ground or gray areas here?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "When we're feeling low, small actions can create positive momentum. What's one tiny thing you could do today that might bring you a small sense of accomplishment?",
    followUp: [
  ...
  },
  {
    ...
    prompt:
      "Let's take a moment to ground ourselves. Can you take three deep breaths with me? Notice how your body feels right now.",
    followUp: [
...
export function getCBTPrompt(
  ...
  return (
    categoryPrompts[Math.floor(Math.random() * categoryPrompts.length)] || null
  );
}
...
export function getMoodSupportResponse(mood: string): string {
  const responses =
    moodSupportResponses[mood as keyof typeof moodSupportResponses];
  if (!responses)
...
export const CBT_TECHNIQUES = {
  ...
  behavioralActivation: {
    ...
    description:
      'Engage in meaningful activities that boost both mental and physical wellbeing',
    activities: [
...
export function getRandomTechnique(
  category: keyof typeof CBT_TECHNIQUES
): string {
  const technique = CBT_TECHNIQUES[category];
  if ('prompts' in technique) {
    return (
      technique.prompts[Math.floor(Math.random() * technique.prompts.length)] ||
  ...
  if ('activities' in technique) {
    return (
      technique.activities[
        Math.floor(Math.random() * technique.activities.length)
  ...
  if ('techniques' in technique) {
    return (
      technique.techniques[
        Math.floor(Math.random() * technique.techniques.length)
